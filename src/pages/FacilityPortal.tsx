...
import { Shield, ClipboardList, Users, RadioTower, ArrowRight } from "lucide-react";
  ...
  const features = [
    {
      ...
      description: "Dashboards for calls, messages, grievances, and deposits in one view.",
    },
    {
      icon: Users,
      title: "Staff Workflows",
      description: "Queues for approvals, reviews, and incident follow-up.",
    },
    {
      icon: RadioTower,
      title: "Real-Time Controls",
      description: "Lockdowns, suspensions, and policy changes applied instantly.",
    },
    {
      icon: Shield,
      title: "Audit-Ready Logs",
      description: "Every action is timestamped and attributed for investigations.",
    },
  ];
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-4">
                <span className="text-foreground">Controls built for </span>
                <span className="text-accent">command staff</span>
              </h1>
              <p className="text-base md:text-lg text-[color:var(--foreground-muted)] max-w-2xl">
                A single pane of glass for security, communication, and financial controls across the
                FreedomTek platform.
              </p>
            </motion.div>
          </div>
          ...
          <div className="container mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
            <div>
              <h2 className="text-2xl md:text-3xl font-semibold mb-2">
                <span className="text-foreground">Ready for a pilot or </span>
                <span className="text-accent">RFP response?</span>
              </h2>
              <p className="text-sm text-[color:var(--foreground-muted)] max-w-xl">
                Our team can map FreedomTek to your current policies and technology stack.
              </p>
            </div>
