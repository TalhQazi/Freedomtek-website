...
import { Video, Calendar, MonitorPlay, Shield, ArrowRight } from "lucide-react";
          ...
          <div className="container mx-auto px-6">
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-4">
                <span className="text-foreground">Face-to-Face </span>
                <span className="text-accent">Video Visits</span>
              </h1>
          ...
          <div className="container mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
            <div>
              <h2 className="text-2xl md:text-3xl font-semibold mb-2">
                <span className="text-foreground">Bring Families </span>
                <span className="text-accent">Closer</span>
              </h2>
