...
import { Video, Calendar, MonitorPlay, Shield, ArrowRight, Sparkles, ChevronRight, Users, Clock, Camera, PlayCircle } from "lucide-react";
...
const VideoModule = () => {
  const features = [
    {
      ...
      description: "Configure visit windows, approvals, and scheduling rules per facility policy.",
    ...
    },
    {
      ...
      description: "Optional recording with retention controls and immutable access logs.",
      gradient: "from-blue-500 to-cyan-400",
      delay: 0.1
    },
    {
      icon: Calendar,
      title: "Family-Friendly Booking",
      description: "Families can book, reschedule, and receive reminders via app and email.",
    ...
    },
    {
      ...
      description: "Adaptive bitrate streaming for secure, reliable calls even on constrained links.",
  ...
  const stats = [
    { icon: Users, label: "Video Visits", value: "200K+" },
    { icon: Clock, label: "Connection Time", value: "99.8%" },
    { icon: Camera, label: "HD Quality", value: "1080p" },
    { icon: PlayCircle, label: "Uptime", value: "99.9%" },
  ];
          ...
          <div className="container mx-auto px-4 sm:px-6 relative z-10">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              >
                ...
                >
                  Secure, scheduled video visits that prioritize family connection while preserving
              ...
              >
                ...
                >
                  {/* Animated Border with Play Button Effect */}
                  <motion.div
                  ...
                  >
                    <motion.img
                      src="/3.jpeg"
                      alt="Secure video visits on FreedomTek platform"
                    ...
                    <div className="flex items-center justify-between gap-4">
                      <div>
                        ...
                        <p className="text-lg font-medium text-white/90">
                          Face-to-face connections with full institutional controls.
                        </p>
                      </div>
                      <motion.div
        ...
        <section className="py-32 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 sm:px-6 relative z-10">
            ...
            >
              ...
              >
                Professional video solutions designed for correctional environments.
              </motion.p>
            </motion.div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative rounded-3xl p-8 bg-gradient-to-br from-white/5 to-white/2 backdrop-blur-xl border border-white/10 group-hover:border-white/20 transition-all duration-500 shadow-lg shadow-black/10">
                      {/* Icon Container with Video Effect */}
                      <motion.div className="relative">
                        ...
                        {/* Video Recording Indicator for Recording Feature */}
                        {feature.title.includes("Recorded") && (
                          <motion.div
                        ...
                        {/* Calendar Animation for Booking Feature */}
                        {feature.title.includes("Booking") && (
                          <motion.div
          ...
          <div className="container mx-auto px-4 sm:px-6 relative z-10">
            ...
            >
              ...
              <motion.p
                ...
                transition={{ delay: 0.2 }}
              >
                Offer scheduled video visits with transparent pricing and full compliance support.
              </motion.p>
              ...
              >
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  {[
                    { label: "Family Satisfaction", value: "98%", color: "text-green-400" },
                    { label: "Visit Completion", value: "99.5%", color: "text-blue-400" },
