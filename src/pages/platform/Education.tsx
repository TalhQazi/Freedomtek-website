...
import { GraduationCap, BookOpen, CheckCircle, ArrowRight, Sparkles, ChevronRight, Target, TrendingDown, Award, Users, Clock, Zap, Brain } from "lucide-react";
...
const EducationModule = () => {
  const features = [
    ...
    },
    {
      ...
      description: "Customized educational journeys aligned with rehabilitation goals.",
  ...
  const impactStats = [
    { icon: TrendingDown, label: "Recidivism Reduction", value: "43%" },
    { icon: Award, label: "Course Completion", value: "89%" },
    { icon: Users, label: "Active Learners", value: "25K+" },
    { icon: Clock, label: "Learning Hours", value: "2M+" },
  ];

  const courseCategories = [
    { icon: GraduationCap, name: "GED Prep", courses: "150+", color: "from-blue-500 to-cyan-400" },
    { icon: Zap, name: "Vocational", courses: "85+", color: "from-green-500 to-emerald-400" },
    { icon: Brain, name: "Life Skills", courses: "120+", color: "from-purple-500 to-pink-400" },
    { icon: CheckCircle, name: "Certifications", courses: "45+", color: "from-orange-500 to-amber-400" },
  ];
        ...
        <section className="py-32 relative overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-background via-background/95 to-background">
            ...
            {Array.from({ length: 8 }).map((_, i) => {
              const icons = [GraduationCap, BookOpen, CheckCircle, Award];
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              >
                ...
                >
                  ...
                  meaningful change and successful re-entry.
                </motion.p>
              ...
              >
                ...
                >
                  ...
                  >
                    <motion.img
                      src="/4.jpeg"
                      alt="FreedomTek education experience"
                    ...
                    <motion.div
                      ...
                      animate="pulse"
                    >
                      <div className="w-20 h-20 rounded-full bg-gradient-to-br from-blue-500 to-cyan-400 flex items-center justify-center shadow-2xl shadow-blue-500/40">
                        <div className="w-16 h-16 rounded-full bg-black/40 flex items-center justify-center">
                          <span className="text-white text-xl font-bold">89%</span>
                        </div>
                      </div>
                    </motion.div>
                    ...
                    <div className="flex items-center justify-between gap-4">
                      <div>
                        ...
                        <p className="text-lg font-medium text-white/90">
                          GED, vocational training, and tracked progress in one place.
                        </p>
                      </div>
                      <motion.div
        ...
        <section className="py-16 relative overflow-hidden">
          <div className="container mx-auto px-4 sm:px-6 relative z-10">
            ...
            >
              ...
              >
                Diverse educational programs designed to support rehabilitation and skill development.
              </motion.p>
            </motion.div>
                  ...
                  >
                    ...
                    <div className="relative rounded-3xl p-8 bg-gradient-to-br from-white/5 to-white/2 backdrop-blur-xl border border-white/10 group-hover:border-white/20 transition-all duration-500 shadow-lg shadow-black/10 text-center">
                      ...
                      <p className="text-sm text-muted-foreground">
                        {category.name === "GED Prep" && "High school equivalency preparation"}
                        {category.name === "Vocational" && "Job skills and certifications"}
                        {category.name === "Life Skills" && "Personal development courses"}
                        {category.name === "Certifications" && "Industry-recognized credentials"}
                      </p>

                      {/* Progress Indicator */}
                      <motion.div 
                        className="h-2 rounded-full bg-white/10 overflow-hidden mt-4"
                        initial={{ width: 0 }}
          ...
          <div className="container mx-auto px-4 sm:px-6 relative z-10">
            ...
            >
              ...
              >
                ...
                trackable experience that drives rehabilitation success.
              </motion.p>
              ...
              >
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  {[
                    { icon: Award, label: "Graduation Rate", value: "89%", color: "text-green-400" },
                    { icon: TrendingDown, label: "Recidivism Drop", value: "43%", color: "text-blue-400" },
                    { icon: Zap, label: "Skill Acquisition", value: "3x Faster", color: "text-purple-400" },
                  ].map((stat, idx) => (
                    <motion.div
                      key={idx}
                      className="p-4 rounded-2xl bg-gradient-to-br from-white/5 to-white/2 backdrop-blur-sm border border-white/10"
              ...
              >
                Need help designing a rehabilitation curriculum?{" "}
