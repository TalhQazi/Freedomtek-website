...
import { Shield, Users, Building2, Target, ArrowRight } from "lucide-react";
  ...
  const pillars = [
    {
      ...
      description:
        "Every workflow is designed to keep facilities, staff, and families safe with audit-ready controls.",
    },
    {
      icon: Users,
      title: "Family-Centered",
      description:
        "We reduce friction and confusion for families with clear pricing and transparent communication.",
    },
    {
      icon: Building2,
      title: "Facility-Grade",
      description:
        "Built for real-world operational constraints across county, state, and federal facilities.",
    },
    {
      icon: Target,
      title: "Outcome Driven",
      description:
        "We measure success in recidivism reduction, safety metrics, and staff efficiency.",
    },
  ];
          ...
          <div className="container mx-auto px-6">
            ...
            >
              <div className="inline-flex items-center gap-2 rounded-full border border-[color:var(--separator)] bg-[color:var(--tile-blue)]/30 px-4 py-1.5 text-xs font-semibold uppercase tracking-[0.16em] text-[color:var(--tile-label)] mb-6">
                ...
                <span>About FreedomTek</span>
              </div>
              <h1 className="text-4xl md:text-5xl font-bold mb-4">
                <span className="text-foreground">Building safer, more </span>
                <span className="text-accent">connected facilities</span>
              </h1>
              <p className="text-base md:text-lg text-[color:var(--foreground-muted)] max-w-2xl">
                FreedomTek4 is a secure communication and services platform purpose-built for correctional
                environments with transparency, control, and family connection at the center.
              </p>
            </motion.div>
          </div>
        </section>
              ...
              {pillars.map((pillar, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <h3 className="font-semibold mb-2 text-sm tracking-wide uppercase">{pillar.title}</h3>
                    <p className="text-xs opacity-85 leading-relaxed">{pillar.description}</p>
                  </motion.div>
                );
              })}
            </div>
          ...
          <div className="container mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
            <div>
              <h2 className="text-2xl md:text-3xl font-semibold mb-2">
                <span className="text-foreground">Want to understand our </span>
                <span className="text-accent">deployment model?</span>
              </h2>
              <p className="text-sm text-[color:var(--foreground-muted)] max-w-xl">
                Talk to our team about pilots, rollouts, and how we integrate with your current
